    ...
    return (
        <div className='mb-10'>
            ...
            <div className='space-y-3'>
                <div className="collapse  text-black dark:text-white bg-white dark:bg-slate-800 border" >
                ...
                <div className="collapse bg-white dark:bg-slate-800 text-black dark:text-white border">
                    <input type="radio" name="my-accordion-1" />
                    <div className="collapse-title text-xl font-medium">
